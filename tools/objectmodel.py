...
class ObjectModel(nn.Module):
    ...
    def forward(self, global_orient=None, transl=None, v_template=None, pose2rot= True, intercap=False, **kwargs):
        ...
        if intercap:
            vertices = torch.matmul(v_template, global_orient.transpose(1,2)) + transl
        else:
