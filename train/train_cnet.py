...
def train():
    ...
    instructions = ''' 
            Please do the following steps before starting the CNet training:
            1. Download GRAB dataset and process CNet dataset using the /data/process_data.py.
    ...
    from configs.config import conf as cfg
